...
from diffsynth.trainers.unified_dataset import UnifiedDataset, LoadVideo, LoadAudio, LoadAudioEmb, ImageCropAndResize, ToAbsolutePath
...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        self,
        model_paths=None, model_id_with_origin_paths=None, audio_processor_config=None, tokenizer_path=None, 
    ...
    def forward_preprocess(self, data):
        ...
        if r < 0.1:
            ...
            mode = "MTI2V"
        inputs_posi['mode'] = inputs_shared["mode"] = mode
...
if __name__ == "__main__":
    ...
    dataset = UnifiedDataset(
        ...
        special_operator_map={
            ...
            "audio_embeds": ToAbsolutePath(args.dataset_base_path) >> LoadAudioEmb(),
        }
    )
